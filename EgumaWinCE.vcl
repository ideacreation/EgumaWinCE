...
<h3>Command Lines</h3>
Creating temporary file "C:\Users\ADMINI~1\AppData\Local\Temp\2\RSP4DEA.tmp" with contents
[
...
Creating command line "cl.exe @C:\Users\ADMINI~1\AppData\Local\Temp\2\RSP4DEA.tmp" 
Creating temporary file "C:\Users\ADMINI~1\AppData\Local\Temp\2\RSP4E48.tmp" with contents
[
...
Creating command line "link.exe @C:\Users\ADMINI~1\AppData\Local\Temp\2\RSP4E48.tmp"
<h3>Output Window</h3>
Compiling...
EgumaWinCE.cpp
C:\Program Files (x86)\Windows CE Tools\wce400\STANDARDSDK\Include\x86\xstring(724) : warning C4530: C++ exception handler used, but unwind semantics are not enabled. Specify -GX
        C:\Program Files (x86)\Windows CE Tools\wce400\STANDARDSDK\Include\x86\xstring(720) : while compiling class-template member function 'void __thiscall std::basic_string<unsigned short,struct std::char_traits<unsigned short>,class std::allocator<unsigned short> >::_Copy(unsigned int)'
C:\Program Files (x86)\Windows CE Tools\wce400\STANDARDSDK\Include\x86\xstring(724) : warning C4530: C++ exception handler used, but unwind semantics are not enabled. Specify -GX
...
Creating temporary file "C:\Users\ADMINI~1\AppData\Local\Temp\2\RSP5165.bat" with contents
[
@echo off
xcopy D:\Projects\EgumaWinCE\X86Dbg\Eguma.dll D:\Projects\EgumaWinCE\EgumaWinCETester\bin\Debug\Eguma.dll /Y
]
Creating command line "C:\Users\ADMINI~1\AppData\Local\Temp\2\RSP5165.bat"
...
<h3>Results</h3>
Eguma.dll - 0 error(s), 2 warning(s)
</pre>
</body>
</html>
